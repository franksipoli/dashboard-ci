    ...
    form.children("div").steps({
        ...
        onStepChanging: function (event, currentIndex, newIndex)
        {
            ...
            if (!form.valid()){
                ...
                $.post(basedir+"/venda/registerAjax", { 
                ...
                function(response){
                    ...
                    if (response.success!==undefined && etapa == "geral"){
                        form.append('<input type="hidden" name="nidcadven" id="nidcadven" value="' + response.id + '">');                        
                    }
                }, "json");             
        ...
        onFinished: function (event, currentIndex)
        {
            ...
            var id = $("#nidcadven").val();

            alert("Venda cadastrada com sucesso!");

            document.location = basedir+"/venda/relatorio";
