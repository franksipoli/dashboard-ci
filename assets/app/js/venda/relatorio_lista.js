function openModalDepositos(venda){
	var returnurl = $("#returnurl").val();
	$.get(baseurl + "/venda/getDadosVendaDepositos/"+venda, null, function(response){
...
jQuery(document).ready(function(){
	var $ = jQuery;
	$(".apagar-venda").unbind('click').click(function(){
		if (!confirm("Deseja realmente excluir a venda? Esta operação é irreversível.")){
			return false;
		}
	})
