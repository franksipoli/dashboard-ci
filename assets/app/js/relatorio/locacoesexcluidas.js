$(document).ready(function(){
	...
	$('#locacao_lista.datatable').dataTable({
		'processing': true
		,'serverSide': true
		,'bFilter': false
		,'language': { url: '../../../assets/vendor/datatables/pt-br.json' }
		,'ajaxSource': '/relatorio/locacoes/excluidas_json?'+url
		,'columns': [
			{ 'render': render_vazio, data: 'ddatainicial', sortable:false },
			{ 'render': render_vazio, data: 'creferencia', sortable:false },
			{ 'render': render_vazio, data: 'cnomegrl', sortable:false },
			{ 'render': render_vazio, data: 'dtdatacriacao', sortable:false },
			{ 'render': render_vazio, data: 'dtdataexc', sortable:false },
			{ 'render': render_vazio, data: 'usuario_criacao', sortable:false },
			{ 'render': render_vazio, data: 'usuario', sortable:false },
