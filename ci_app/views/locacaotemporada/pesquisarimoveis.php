            ...
            <form class="form-horizontal" id="frmPesquisaImoveis" method="GET" action="<?php echo makeUrl("locacaotemporada","resultadoimoveis")?>">
               ...
               <div role="tabpanel">
                 ...
                 <ul role="tablist" class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="#periodo" aria-controls="periodo" role="tab" data-toggle="tab" aria-expanded="true">Período</a>
                    </li>
                    <!--
                    <li role="presentation" class=""><a href="#diaria" aria-controls="diaria" role="tab" data-toggle="tab" aria-expanded="false">Diária &amp; Pacotes</a>
                    </li>
                 ...
                 <div class="tab-content">
                    <div id="periodo" role="tabpanel" class="tab-pane active">
                      ...
                      <input type="hidden" name="nidtbxfin" value="<?php echo Parametro_model::get('finalidade_locacao_id')?>">
                       ...
                       -->
                         ...
                         /*
                         <div class="form-group">
                            <label class="col-lg-2 control-label">Relação de Bens</label>
                            <div class="col-lg-10">
                    ...
                    <!-- Retirando as Diarias
                    
                    <div id="diaria" role="tabpanel" class="tab-pane">
