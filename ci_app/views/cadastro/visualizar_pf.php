		...
		<div class="panel-body">
			...
			<table class="table">
				...
				<tr>
					...
					<td>
						<?php
							echo !empty($cadfis->ddtnasc) ? toUserDate($cadfis->ddtnasc) : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
					...
					<td>
						<?php
							echo !empty($tbxnac->cdescrinac) ? $tbxnac->cdescrinac : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<?php
							echo !empty($cadfis->ddtemirg) ? toUserDate($cadfis->ddtemirg) : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
					...
					<td>
						<?php
							echo !empty($tbxemi->cdescriemi) ? $tbxemi->cdescriemi : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
					...
					<td>
						<?php
							echo !empty($tbxest->cdescriest) ? $tbxest->cdescriest : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
					...
					<td>
						<?php
							echo !empty($tbxcbo->cdescricbo) ? $tbxcbo->cdescricbo : "<i>Não preenchido</i>";
						?>
					</td>
				</tr>
				<tr>
